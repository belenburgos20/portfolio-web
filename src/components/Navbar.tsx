    ...
    >
      ...
      >
        ...
        <a
          ...
          className="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 text-sm font-body text-primary-light hover:bg-primary/10 hover:border-primary/60 transition-colors duration-200"
        >
